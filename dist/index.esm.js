...
var spinStyle = css(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  animation: ", " 2s linear infinite;\n"], ["\n  animation: ", " 2s linear infinite;\n"])), rotate$1);
...
var templateObject_1$O, templateObject_2$h, templateObject_3$9;
...
var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 205" }, props),
        React.createElement("image", { width: "205", height: "205", href: '/images/egg/logo.png' })));
};
...
var Details = styled.div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"], ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"])), function (_a) {
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$_, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$I, templateObject_2$g, templateObject_3$8, templateObject_4$4;
...
var StyledBreadcrumbs = styled.ul(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  ", "\n"], ["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var DefaultSeparator = React.createElement(Icon$10, { color: "currentColor", width: "24px" });
...
var Container$4 = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var Bunny = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"], ["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"])), function (_a) {
    var position = _a.position;
    return position + "vw";
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArrays(Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$U, { width: size, height: size }))); });
...
var Dot = styled.span(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  display: ", ";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 10px;\n  height: 10px;\n  pointer-events: none;\n  border: 2px solid ", ";\n  border-radius: 50%;\n  background-color: ", ";\n"], ["\n  display: ", ";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 10px;\n  height: 10px;\n  pointer-events: none;\n  border: 2px solid ", ";\n  border-radius: 50%;\n  background-color: ", ";\n"])), function (_a) {
    var show = _a.show;
...
var StyledTag = styled.div(templateObject_1$o || (templateObject_1$o = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border: 2px solid ", ";\n  border-radius: 0px;\n  color: #ffffff;\n  display: inline-flex;\n  font-size: 12px;\n  font-weight: 400;\n  height: 21px;\n  line-height: 1.5;\n  padding: 0px 3px;\n  margin: 0px 2px;\n  white-space: nowrap;\n\n  & > svg {\n    fill: currentColor;\n  }\n\n  ", "\n  ", "\n  ", "\n\n  ", "\n"], ["\n  align-items: center;\n  background-color: ",
    ...
    "\n  ",
    "\n  ", "\n\n  ", "\n"])), function (_a) {
    var outline = _a.outline, theme = _a.theme, color = _a.color, _b = _a.variant, variant = _b === void 0 ? "primary" : _b;
    return outline ? "transparent" : (color !== null && color !== void 0 ? color : getColor(variant, theme));
}, function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? "primary" : _b, theme = _a.theme, color = _a.color;
    return (color !== null && color !== void 0 ? color : getColor(variant, theme));
}, variant$1({
    prop: "scale",
...
var StyledProgress = styled.div(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  position: relative;\n  background-color: ", ";\n  box-shadow: ", ";\n  height: 16px;\n  overflow: hidden;\n\n  ", " {\n    border-top-left-radius: ", ";\n    border-bottom-left-radius: ", ";\n  }\n\n  ", "\n  ", "\n"], ["\n  position: relative;\n  background-color: ", ";\n  box-shadow: ", ";\n  height: 16px;\n  overflow: hidden;\n\n  ", " {\n    border-top-left-radius: ", ";\n    border-bottom-left-radius: ", ";\n  }\n\n  ",
    ...
    return (variant === variants.FLAT ? "0" : "0");
}, function (_a) {
    var variant = _a.variant;
    return (variant === variants.FLAT ? "0" : "0");
}, variant$1({
...
var SliderLabel = styled.label(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"], ["\n  position: absolute;\n  bottom: 0;\n  margin-left: 16px; // offset the bunny butt width\n  left: calc(", "%);\n"])), function (_a) {
    var progress = _a.progress;
    return progress;
});
styled.img(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n"], ["\n  position: absolute;\n"])));
var BunnySlider = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"], ["\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"])));
...
var templateObject_1$k, templateObject_2$9, templateObject_3$7, templateObject_4$3, templateObject_5$3, templateObject_6, templateObject_7;
...
var Slider = function (_a) {
    ...
    return (React.createElement(SliderContainer, __assign({}, props),
        React.createElement(Icon$y, { style: { position: "absolute" } }),
...
var RotatingPancakeIcon = styled(Icon$w)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$x)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$j, templateObject_2$8, templateObject_3$6, templateObject_4$2, templateObject_5$2;
...
var templateObject_1$i, templateObject_2$7, templateObject_3$5, templateObject_4$1, templateObject_5$1;
...
var ModalHeader = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"], ["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"])));
...
var templateObject_1$g, templateObject_2$5, templateObject_3$3;
...
var Icon$9 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "
= function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React.createElement("path", { d: "M41.625 10.77c-3.98-3.204-10.277-3.747-10.547-3.766a.992.992 0 00-.988.586 6.63 6.63 0 00-.305.832c2.633.445 5.867 1.34 8.793 3.156a1 1 0 11-1.055 1.7C32.493 10.155 26.211 10 25 10c-1.21 0-7.496.156-12.523 3.277a1 1 0 01-1.055-1.7c2.926-1.811 6.16-2.71 8.793-3.151-.152-.496-.29-.809-.3-.836a.987.987 0 00-.993-.586c-.27.02-6.567.562-10.602 3.809C6.215 12.761 2 24.152 2 34c0 .176.047.344.133.496 2.906 5.11 10.84 6.445 12.648 6.504h.031a1 1 0 00.81-.41l1.827-2.516c-4.933-1.273-7.453-3.437-7.597-3.566a1 1 0 111.324-1.5C11.234 33.063 15.875 37 25 37c9.14 0 13.781-3.953 13.828-3.992a1 1 0 011.41.094.996.996 0 01-.09 1.406c-.144.129-2.664 2.293-7.597 3.566l1.828 2.516a1 1 0 00.809.41h.03c1.81-.059 9.743-1.395 12.65-6.504A1.01 1.01 0 0048 34c0-9.848-4.215-21.238-6.375-23.23zM18.5 30c-1.934 0-3.5-1.79-3.5-4s1.566-4 3.5-4 3.5 1.79 3.5 4-1.566 4-3.5 4zm13 0c-1.934 0-3.5-1.79-3.5-4s1.566-4 3.5-4 3.5 1.79 3.5 4-1.566 4-3.5 4z" })));
};

var Icon$7 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 -80 1067 859" }, props),
        React.createElement("path", { id: "path0", d: "M480.026 640.677c17.205 0 31.2 13.997 31.2 31.194s-13.995 31.193-31.2 31.193c-17.197 0-31.193-13.996-31.193-31.193 0-17.197 13.996-31.194 31.193-31.194m489.93-193.226c-17.203 0-31.2-13.998-31.2-31.195 0-17.204 13.997-31.2 31.2-31.2 17.198 0 31.194 13.996 31.194 31.2 0 17.197-13.996 31.195-31.193 31.195m0-127.804c-53.269 0-96.609 43.34-96.609 96.609 0 10.373 1.723 20.702 5.123 30.741L559.328 616.879c-18.132-26.128-47.521-41.617-79.302-41.617-36.821 0-70.391 21.065-86.63 54.003L106.68 478.109c-30.288-15.927-52.965-65.817-50.56-111.223 1.248-23.687 9.438-42.071 21.897-49.17 7.916-4.493 17.436-4.099 27.526 1.188l1.916 1.01c75.96 40.022 324.6 170.981 335.063 175.844 16.157 7.47 25.14 10.5 52.659-2.547l513.958-267.3c7.53-2.844 16.315-10.062 16.315-21.023 0-15.205-15.72-21.199-15.765-21.199-29.218-14.018-74.163-35.054-117.987-55.57C798.033 84.26 691.861 34.547 645.23 10.132c-40.253-21.072-72.655-3.311-78.432.282l-11.227 5.555C345.727 119.743 64.898 258.826 48.911 268.553 20.278 285.973 2.547 320.679.252 363.768c-3.586 68.304 31.261 139.506 81.069 165.634l303.172 156.354c6.83 47.306 47.55 82.725 95.532 82.725 52.78 0 95.808-42.546 96.603-95.14L910.541 492.38c16.93 13.233 37.92 20.486 59.416 20.486 53.268 0 96.61-43.341 96.61-96.61s-43.342-96.61-96.61-96.61", stroke: "none" })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$U, { className: "mobile-icon" }),
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "SishiFinance home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "SishiFinance home page" }, innerLogo))));
};
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive },
            ...
            isOpen ? React.createElement(Icon$1b, null) : React.createElement(Icon$1c, null)),
        ...
        if (entry.items) {
            ...
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, __assign({ href: item.href }, item.newTab ? { target: "_blank" } : {}), item.label))); })));
        }
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, __assign({ href: entry.href, onClick: handleClick }, entry.newTab ? { target: "_blank" } : {}),
                iconElement,
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0x8e8538c75f273ab2df6adeecd3622a9c314fccf3", target: "_blank" },
        React.createElement(Icon$N, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true },
            "SISHI ", "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$X, { width: "20px", color: "primary", ml: "4px" }),
            ...
            React.createElement(Flex, null,
                React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { height: "24px", padding: "0 5px", marginRight: "10px" } },
                    React.createElement(Flex, { alignItems: "center" },
                        React.createElement(Icon$j, { color: isDark ? "textDisabled" : "text", width: "18px" }),
                        React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                        React.createElement(Icon$n, { color: isDark ? "text" : "textDisabled", width: "18px" }))),
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout }))),
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: true, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links }),
            React.createElement(Inner, { isPushed: isPushed, showMenu: true }, children),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
...
export { Icon$1f as AddIcon, Alert, Icon$1e as ArrowBackIcon, Icon$1d as ArrowDownIcon, Icon$1c as ArrowDropDownIcon, Icon$1b as ArrowDropUpIcon, Icon$1a as ArrowForwardIcon, Icon$19 as ArrowUpIcon, Icon$18 as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$17 as BinanceIcon, Icon$1h as BlockIcon, Box, Breadcrumbs, Icon$16 as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$14 as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$15 as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1j as CheckmarkCircleIcon, Icon$13 as CheckmarkIcon, Icon$12 as ChevronDownIcon, Icon$11 as ChevronLeftIcon, Icon$10 as ChevronRightIcon, Icon$$ as ChevronUpIcon, Icon$_ as CloseIcon, Icon$Z as CogIcon, Icon$Y as CommunityIcon, ConnectorNames, Icon$X as CopyIcon, Dropdown, Icon$1i as ErrorIcon, FallingBunnies, Flex, Heading, Icon$W as HelpIcon, IconButton, Image, Icon$1g as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$V as ListViewIcon, Icon$U as LogoIcon, Icon$T as LogoRoundIcon, Menu, Icon$S as MetamaskIcon, Icon$R as MinusIcon, Modal, ModalProvider, Icon$Q as NoProfileAvatarIcon, NotificationDot, Icon$P as OpenNewIcon, Icon$N as PancakeRoundIcon, Icon$O as PancakesIcon, Icon$M as PlayCircleOutlineIcon, Icon$L as PrizeIcon, Progress, Icon$I as ProgressBunny, Radio, Icon$K as RemoveIcon, ResetCSS, Icon$C as SearchIcon, Skeleton, Slider, Spinner, Svg, Icon$B as SwapVertIcon, Icon$A as SyncAltIcon, Tag, Text, Icon$F as Ticket, Icon$E as TicketRound, Icon$D as TimerIcon, ToastContainer, Toggle, Icon$J as VerifiedIcon, Icon$H as WaitIcon, Icon$z as WarningIcon, Icon$G as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
