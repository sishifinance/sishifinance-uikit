...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "SishiFinance home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "SishiFinance home page" }, innerLogo))));
};
...
styled.div(templateObject_2$f || (templateObject_2$f = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"])), MENU_ENTRY_HEIGHT);
            ...
            React.createElement(Flex, null,
                React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { height: "24px", padding: "0 5px", marginRight: "10px" } },
                    React.createElement(Flex, { alignItems: "center" },
                        React.createElement(Icon$10, { color: isDark ? "textDisabled" : "text", width: "18px" }),
                        React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                        React.createElement(Icon$Y, { color: isDark ? "text" : "textDisabled", width: "18px" }))),
