...
var getFontSize = function (_a) {
    ...
    return small ? "12.5px" : fontSize || "14px";
};
...
var Icon$12 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 400 400" }, props),
        React.createElement("path", { id: "path0", d: "M130.081 9.983 C -19.413 66.501,-47.951 258.306,77.873 360.875 C 142.410 413.484,257.590 413.484,322.127 360.875 C 444.435 261.172,419.202 68.577,276.432 12.091 C 239.235 -2.626,166.214 -3.678,130.081 9.983 M250.603 41.598 C 346.810 71.624,393.488 181.530,348.605 272.346 C 282.291 406.523,85.920 392.616,41.598 250.603 C 1.367 121.697,121.697 1.367,250.603 41.598 M162.500 99.782 L 162.500 116.231 140.625 117.491 C 113.908 119.029,106.773 137.427,131.250 141.667 L 143.750 143.832 143.750 197.958 L 143.750 252.083 132.292 253.402 C 108.093 256.186,116.455 279.167,141.667 279.167 L 162.500 279.167 162.500 295.833 C 162.500 310.833,163.542 312.500,172.917 312.500 C 182.292 312.500,183.333 310.833,183.333 295.833 C 183.333 281.944,184.722 279.167,191.667 279.167 C 198.611 279.167,200.000 281.944,200.000 295.833 C 200.000 310.833,201.042 312.500,210.417 312.500 C 219.742 312.500,220.833 310.802,220.833 296.297 C 220.833 281.002,221.671 279.937,235.788 277.289 C 269.205 271.019,283.333 256.343,283.333 227.899 C 283.333 213.373,268.040 191.667,257.806 191.667 C 254.981 191.667,256.873 187.240,262.054 181.725 C 282.404 160.064,267.010 128.248,232.822 121.308 C 219.803 118.665,218.654 117.137,217.469 100.892 C 215.571 74.886,195.833 74.072,195.833 100.000 C 195.833 112.037,194.097 116.667,189.583 116.667 C 185.069 116.667,183.333 112.037,183.333 100.000 C 183.333 85.000,182.292 83.333,172.917 83.333 C 163.565 83.333,162.500 85.015,162.500 99.782 M221.107 145.980 C 241.962 157.141,228.039 183.333,201.250 183.333 L 183.333 183.333 183.333 162.500 L 183.333 141.667 198.191 141.667 C 206.362 141.667,216.675 143.608,221.107 145.980 M233.607 212.647 C 257.530 225.450,234.476 254.167,200.274 254.167 L 183.333 254.167 183.333 231.250 L 183.333 208.333 204.441 208.333 C 216.050 208.333,229.175 210.274,233.607 212.647 ", stroke: "none", fill: "#8302ff", "fill-rule": "evenodd" })));
};
...
var ExpandableButton = function (_a) {
    ...
    return (React.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React.createElement(Icon$1q, { color: "invertedContrast" }) : React.createElement(Icon$1t, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React.createElement(Icon$1q, { color: "primary" }) : React.createElement(Icon$1t, { color: "primary" }) }, children));
};
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$1p, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$1r, { color: "currentColor", width: "24px" });
...
var RotatingPancakeIcon = styled(Icon$y)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$z)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var getOutlineStyles = function (_a) {
    var outline = _a.outline, theme = _a.theme, _b = _a.variant, variantKey = _b === void 0 ? variants.PRIMARY : _b, customColor = _a.color;
    if (outline) {
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1p, { color: "primary" })));
};
...
var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M20 4H4C2.897 4 2 4.897 2 6V18C2 19.103 2.897 20 4 20H20C21.103 20 22 19.103 22 18V6C22 4.897 21.103 4 20 4ZM4 18V6H20L20.002 18H4Z" }),
        React.createElement("path", { d: "M12 14H18V16H12V14ZM6 10L8.293 12.293L6 14.586L7.414 16L11.121 12.293L7.414 8.586L6 10Z" })));
};
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React.createElement(Icon$1H, null) : React.createElement(Icon$1I, null)),
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        var _a;
        var Icon = Icons$1[entry.icon] || Icons$1["LayerIcon"];
            ...
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) {
                    ...
                    return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                        React.createElement(MenuLink, __assign({ href: item.href }, entry.newTab ? { target: "_blank" } : {}),
                            React.createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                            item.status && (React.createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, (_a = item.status.text) !== null && _a !== void 0 ? _a : " ")))));
                })));
        }
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, __assign({ href: entry.href, onClick: handleClick }, entry.newTab ? { target: "_blank" } : {}),
                ...
                entry.status && (React.createElement(LinkStatus, { color: entry.status.color, fontSize: "14px" }, (_a = entry.status.text) !== null && _a !== void 0 ? _a : " ")))));
    })));
};
var templateObject_1$a;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://exchange.sishi.finance/#/swap?outputCurrency=0x8E8538c75f273aB2dF6AdEEcD3622A9c314fcCf3", target: "_blank" },
        React.createElement(Icon$12, { width: "24px", mr: "8px" }),
    ...
    if (!isPushed) {
        return (React.createElement(Container, null,
            React.createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
                React.createElement(Icon$1o, null))));
    }
    return (React.createElement(Container, null,
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/get-started/connection-guide", external: true },
            React.createElement(Icon$1k, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$1m, { width: "20px", color: "primary", ml: "4px" }),
            ...
            !!login && !!logout && (React.createElement(Flex, null,
                React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { height: "24px", padding: "0 5px", marginRight: "10px" } },
                    React.createElement(Flex, { alignItems: "center" },
                        React.createElement(Icon$l, { color: isDark ? "textDisabled" : "text", width: "18px" }),
                        React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                        React.createElement(Icon$p, { color: isDark ? "text" : "textDisabled", width: "18px" }))),
