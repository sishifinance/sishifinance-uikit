...
var uikit = require('@pancakeswap-libs/uikit');
...
var Icon$14 = function (props) {
    return (React__default['default'].createElement(uikit.Svg, __assign({ viewBox: "0 -80 1067 859" }, props),
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { height: "24px", padding: "0 5px", marginRight: "10px" } },
                    React__default['default'].createElement(Flex, { alignItems: "center" },
                        ...
                        React__default['default'].createElement(Icon$Q, { color: isDark ? "text" : "textDisabled", width: "18px" }))),
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout }))),
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: true, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink }),
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: true }, children),
            React__default['default'].createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
var templateObject_1$G, templateObject_2$e, templateObject_3$8, templateObject_4$3, templateObject_5$1;
