...
var RotatingPancakeIcon = styled__default['default'](Icon$y)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled__default['default'](Icon$z)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            ...
            isOpen ? React__default['default'].createElement(Icon$1H, null) : React__default['default'].createElement(Icon$1I, null)),
            ...
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) {
                    ...
                    return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                        React__default['default'].createElement(MenuLink, __assign({ href: item.href }, entry.newTab ? { target: "_blank" } : {}),
                            React__default['default'].createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                            item.status && (React__default['default'].createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, (_a = item.status.text) !== null && _a !== void 0 ? _a : " ")))));
                })));
        }
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, __assign({ href: entry.href, onClick: handleClick }, entry.newTab ? { target: "_blank" } : {}),
                iconElement,
                React__default['default'].createElement(LinkLabelMemo, { isPushed: isPushed }, entry.label),
                entry.status && (React__default['default'].createElement(LinkStatus, { color: entry.status.color, fontSize: "14px" }, (_a = entry.status.text) !== null && _a !== void 0 ? _a : " ")))));
    })));
};
var templateObject_1$a;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://exchange.sishi.finance/#/swap?outputCurrency=0x8E8538c75f273aB2dF6AdEEcD3622A9c314fcCf3", target: "_blank" },
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/get-started/connection-guide", external: true },
            React__default['default'].createElement(Icon$1k, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$1m, { width: "20px", color: "primary", ml: "4px" }),
            ...
            !!login && !!logout && (React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); }, style: { height: "24px", padding: "0 5px", marginRight: "10px" } },
                    React__default['default'].createElement(Flex, { alignItems: "center" },
                        React__default['default'].createElement(Icon$l, { color: isDark ? "textDisabled" : "text", width: "18px" }),
                        React__default['default'].createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                        React__default['default'].createElement(Icon$p, { color: isDark ? "text" : "textDisabled", width: "18px" }))),
...
exports.CircleOutlineIcon = Icon$1w;
exports.CloseIcon = Icon$1p;
exports.CogIcon = Icon$1o;
exports.CommunityIcon = Icon$1n;
exports.CopyIcon = Icon$1m;
exports.CrownIcon = Icon$1l;
...
exports.PlayCircleOutlineIcon = Icon$10;
exports.PocketWatchIcon = Icon$11;
